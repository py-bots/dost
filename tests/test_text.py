...
#     unittest.main()
def test_string_extract_only_alphabets(self):
    self.assertEqual(text.string_extract_only_alphabets("hello123:l;,") , 'hellol')
...
def test_string_remove_special_characters(self):
    self.assertEqual(text.string_remove_special_characters("hello123:l;,") , 'hello123l')
