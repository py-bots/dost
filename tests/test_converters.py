...
class test(unittest.TestCase):
    def test_convert_csv_to_excel(self):
        return 0
        convert_csv_to_excel(input_file=r'tests\demo.csv')
        ...
        convert_csv_to_excel(input_file=r'tests\demo.csv', output_folder=r'tests',output_filename="demo.xlsx",contains_headers=True,sep=",")
    ...
    def test_base_to_img(self):
        convert_base64_to_image(self.str)
        convert_base64_to_image(self.str,'tests')
        convert_base64_to_image(self.str,"demo_base_img")
        convert_base64_to_image(self.str,'tests',"demo_base_img")
    ...
    def test_colored_html(self):
        ...
        excel_to_colored_html('tests\\demo.xlsx', output_filename="demo")
        excel_to_colored_html('tests\\demo.xlsx', output_folder=r'tests', output_filename="demo")
